...
/**
 * REST controller for managing {@link co.com.pruebantt.domain.Cliente}.
 */
@RestController
@RequestMapping("/api")
public class ClienteResource {
    ...
    @PostMapping("/clienteQuemado/{tipoIdentificacion}/{numeroIdentificacion}")
    public ResponseEntity<List<ClienteDTO>> clienteQuemado(
        @PathVariable String tipoIdentificacion,
        @PathVariable String numeroIdentificacion
    ) {
        log.debug("REST requet to get default customer");
        return ResponseEntity.ok().body(clienteService.clientesQuemados(tipoIdentificacion, numeroIdentificacion));
    }
